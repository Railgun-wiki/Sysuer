                        ...
                        if (response.get("data") != null) {
                            switch (msg.what) {
                                case 2: {
                                    ...
                                    data.getJSONArray("rows").forEach(a -> ((StaggeredFragment) adp.getItem(2)).add(RegisterInfoActivity.this, ((JSONObject) a).getString("academicYearTerm"), R.drawable.calendar, List.of(new String[]{"学年学期", "校区", "学院", "年级专业", "缴费状态", "报到状态", "注册状态", "报到日期", "注册日期"}),
                                ...
                                case 0: {
                                    ((StaggeredFragment) adp.getItem(0)).add(RegisterInfoActivity.this, "学生报到信息", List.of("学号", "注册学年学期", "报到状态", "注册状态", "缴费状态"),
                                ...
                                case 1: {
                                    ...
                                    d.forEach(v -> {
                                        ...
                                        page2.add(RegisterInfoActivity.this, ((JSONObject) v).getString("acadYear"), R.drawable.money, List.of(new String[]{"年份", "类别", "项目名称", "金额（元）", "区间", "时间"}),
